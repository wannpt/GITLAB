#include <stdio.h>
void main()
{ //firstuser to Phond Ming
  char Name[30][40] = {"Phond Ming", "Mary McBeth", "Ying Phakpon","Chai Chanchai", "Yong Boonsith", "Kitti Karndee"}; 
  int ID[30] = {5301, 5302, 5303, 5304, 5305, 5306}; 
  float GPA[30] = {4.00, 2.35, 3.65, 3.24, 1.32, 3.26}; //grade to 4.00
  int N = 6, i;
